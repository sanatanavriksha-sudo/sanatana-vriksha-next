...
// Static copy of SVData.categories — UI metadata only, not service rows.
// Keeps this file free of the SVData import so the full data module is not
...
export default function ServicesClient({ categoryItems }: {
  categoryItems: Record<string, ServiceItem[]>;
}) {
  const CATEGORY_INFO: Record<string, CategoryInfo> = {
    homas:      { dev: "अग्नि",  kicker: "Homas",              title: "Sacred Fire Rituals — Homas",        sub: "Vedic fire ceremonies invoking divine energies for healing, protection, and prosperity.",                          items: categoryItems.homas      ?? [], bg: "section--cream" },
    poojas:     { dev: "अर्चना", kicker: "Poojas",             title: "Devotional Worship — Poojas",         sub: "Traditional deity worship and personalized services performed with mantras and devotion.",                      items: categoryItems.poojas     ?? [], bg: "section--beige" },
    samskaras:  { dev: "संस्कार",kicker: "Samskaras",          title: "Life-Milestone Ceremonies — Samskaras",sub: "Family-centered Vedic rites that sanctify every sacred passage of life.",                                    items: categoryItems.samskaras  ?? [], bg: "section--cream" },
    specialized:{ dev: "विशेष", kicker: "Specialized Services", title: "Specialized Poojas & Homas",          sub: "Personalized spiritual services for specific needs, family occasions, guidance, and blessings.",               items: categoryItems.specialized ?? [], bg: "section--beige" },
  };
